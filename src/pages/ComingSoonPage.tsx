    ...
    <div className="w-full bg-[#F5F4EF] text-[#17191B] font-sans selection:bg-[#B59A68]/20 selection:text-[#17191B] relative">
      ...
      <header className="fixed top-0 left-0 w-full z-50 bg-[#F5F4EF]/90 backdrop-blur-md border-b border-[#141516]/8 transition-all">
        <div className="max-w-[1280px] mx-auto px-6 sm:px-10 h-16 flex items-center justify-between gap-4">
          ...
          {/* Quick Phone Callback in Header */}
          <div className="flex items-center gap-3">
            {!submitted ? (
              <form onSubmit={handleSubmit} className="hidden sm:flex items-center bg-white border border-[#141516]/12 rounded-[3px] p-1 focus-within:border-[#A88A58] transition-all">
              ...
              <div className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 bg-emerald-50 border border-emerald-300 rounded-[3px] text-[10px] font-mono text-emerald-800">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600" />
                <span>Call requested. We'll call you back shortly!</span>
              </div>
            )}
      ...
      {/* ── 1. The Interactive 3D Structure Assembly Hero ─────────── */}
      <Hero3D />

      {/* ── 2. Simple Single-Line Action Section ──────────────────── */}
      <section className="bg-white border-t border-[#141516]/8 py-20 px-6">
        <div className="max-w-[720px] mx-auto text-center flex flex-col items-center gap-6">
          
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#F5F4EF] border border-[#141516]/8 rounded-full text-[10px] font-mono text-[#A88A58] font-bold uppercase tracking-widest">
            ...
            {!submitted ? (
              <form onSubmit={handleSubmit} className="flex items-center bg-[#F5F4EF] border border-[#141516]/15 focus-within:border-[#A88A58] rounded-[4px] p-1.5 transition-all shadow-sm">
                ...
                <input
                  ...
                  value={phone}
                  onChange={(e) => setPhone(e.target.value)}
                  className="bg-transparent border-none text-sm text-[#141516] placeholder-[#141516]/40 focus:outline-none flex-1 font-mono tracking-wide py-2"
                />
                <button
                  type="submit"
          ...
          <div className="w-full border-t border-[#141516]/8 pt-8 mt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-[#7A7D80]">
            <span>saifi.electricals2@gmail.com · Amroha, UP · GST: 09BDRPA4213J1ZJ</span>
            <Link
              to="/home"
              className="text-[#A88A58] hover:text-[#141516] transition-colors flex items-center gap-1 uppercase tracking-wider font-semibold"
            >
